...
Он создаёт 32 слайда: четыре вводных и по одному слайду на каждый из 28 шагов. Для сборки нужен `@oai/artifact-tool` из среды Codex. Итоговый PPTX доступен в GitHub Release `v1.0.0`.
